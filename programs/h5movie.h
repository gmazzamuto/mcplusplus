...
public:
    ...
    void loadFrame(hsize_t t, MCfloat *destBuffer);
    void writeFrame(MCfloat *srcBuffer, hsize_t t);
    ...
    MCfloat *frameData; /**< \brief Default buffer where the frame data is stored.
                            \see loadFrame() **/
